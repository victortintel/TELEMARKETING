...
def main():
    ...
    if data_file_1 is not None:
        ...
        # Ajuste: Criar DataFrame com colunas 'index' e 'percentage'
        ...
        if graph_type == 'Barras':
            sns.barplot(x=bank_raw_target_perc['y'], 
            ...
            sns.barplot(x=bank_target_perc['y'], 
            ...
            bank_raw_target_perc.set_index('y').plot(kind='pie', y='percentage', autopct='%.2f%%', ax=ax[0])
            ax[0].set_title('Dados brutos',
                            fontweight="bold")
            
            bank_target_perc.set_index('y').plot(kind='pie', y='percentage', autopct='%.2f%%', ax=ax[1])
            ax[1].set_title('Dados filtrados',
                            fontweight="bold")
